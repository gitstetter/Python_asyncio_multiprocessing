...
if __name__ == "__main__":
    ...
    print("Making {:,} samples per {} worker processes".format(nbr_samples_per_worker, nbr_parallel_blocks))
    nbr_trials_per_process = nbr_samples_per_worker#[nbr_samples_per_worker] * nbr_parallel_blocks
    t1 = time.time()
...
# Making 250,000,000.0 samples per 4 worker processes
# Executing estimate_nbr_points_in_quarter_circle with 250,000,000.0 on pid 30485
# Executing estimate_nbr_points_in_quarter_circle with 250,000,000.0 on pid 30486
